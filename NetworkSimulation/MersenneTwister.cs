...
namespace NetworkSimulation
{
    public class MersenneTwister
    {
        ...
        /*
         * The purpose of this function is to generate a random number from a Pareto 
         * distribution.  It uses the inverse function of F(x) which takes input generated
         * randomly from a uniform distribution.
         */
        public double genparet_real(double alpha, double beta)
        {
            double random = 1.0 / (1.0 - genrand_real1());  
            double root = 1.0 / alpha;
            double exprand = (Math.Pow(random, root) - 1.0) * beta; 
